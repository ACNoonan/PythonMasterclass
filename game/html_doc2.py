...
class DocType(Tag):
    ...
    def __init__(self):
        super().__init__('!DOCTYPE HTML PUBLIC "-//W3C/DTD HTML 4.01//EN" http://wwww.w3.org/TR/html4/strict.dtd', '')
...
if __name__ == '__main__':
    ...
    #     my_page.add_tag('p', 'This is the first paragraph that will appear on the page.')
    ...
    new_body.add_tag('p', "The composed object doesn't actually own the objects that it "
                      "is composed of - if it's destroyed, those objects continue to exist.")
